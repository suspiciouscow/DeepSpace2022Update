...
public class OI {
	...
	public int level1ButtonNumberCargo = 100; // Changed from
	public int level2ButtonNumberCargo = 101; // Changed from // fix these
	public int level3ButtonNumberCargo = 102; // Changed from

	public int liftAxisNumber = 10; // Changed from //and this
